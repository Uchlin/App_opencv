...
class MainWindow(QWidget):
    ...
    def initUI(self):
        ...
        # Показываем приветственное сообщение на видео виджете
        self.show_welcome_message()
    
    def show_welcome_message(self):
        """Показывает приветственное сообщение на виджете видео"""
        if self.video_widget:
            self.video_widget.video_label.setText(
                "🎬 Добро пожаловать!\n\n"
                "Чтобы начать работу:\n"
                "1. Нажмите 'Файл' → 'Открыть...'\n"
                "2. Выберите видео файл\n"
                "3. Используйте кнопки Play/Pause/Stop для управления"
            )
            # Стилизуем приветственное сообщение
